		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.zuixinzhengce" placeholder="最新政策" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
				...
				<el-button class="list-add-btn" v-if="btnAuth('laodongbaozhang','新增')" type="primary" @click="add('/index/laodongbaozhangAdd')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.zuixinzhengce != '') searchWhere.zuixinzhengce = '%' + this.formSearch.zuixinzhengce + '%';
				...
				this.$http.get(`laodongbaozhang/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/laodongbaozhangDetail', query: params});
			},
